...
#матрица
matrix = pd.read_csv('glue/onoffmatrix_avg.csv', sep = ';', encoding='cp1251')
matrix = matrix[matrix['hour_on']==7]
matrix = matrix[['stop_id_from','stop_id_to','movements_norm']]

#остановки-суперсайты
stops_supers = pd.read_csv('glue/stops_supers.csv', sep = ';', encoding='cp1251')
...
supers_Moscow = pd.read_csv('glue/supers_Mercator.csv', sep = ';')
...
#сайты Тушино из
supers_T = pd.read_csv('glue/supersites_Tushino.csv', sep = ';')
